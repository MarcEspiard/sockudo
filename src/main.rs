...
async fn main() -> Result<()> {
    ...
    // Note: Environment variable overrides are handled in config.override_from_env() above.
    // The following variables are already processed there and don't need duplicate handling:
    // HOST, PORT, SHUTDOWN_GRACE_PERIOD, INSTANCE_PROCESS_ID, ADAPTER_DRIVER, CACHE_DRIVER,
    // QUEUE_DRIVER, RATE_LIMITER_DRIVER, SSL_*, DATABASE_REDIS_*, REDIS_CLUSTER_*, METRICS_*
